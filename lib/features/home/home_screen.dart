                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: BooyahTheme.maroonB, blurRadius: 6),
                        ],
                      ),
                    ),
            ...
            RichText(
              text: const TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: 'SCRIM',
                    style: TextStyle(color: BooyahTheme.maroonB),
                  ),
                  TextSpan(text: '\nTERBAIK'),
                ],
              ),
...
class _StatBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Expanded(
    child: Container(
      ...
      child: Column(
        children: [
          Icon(icon, size: 18, color: BooyahTheme.maroonB),

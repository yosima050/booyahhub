  ...
  Widget build(BuildContext ctx) {
    ...
    return Scaffold(
      body: _loading
          ...
          : CustomScrollView(
              slivers: [
                // 1. BAGIAN HEADER (Sudah aman dari notch & ikon baterai HP)
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: SafeArea(
                      bottom: false, // Menjaga area atas saja
                      child: Padding(
                ...
                // 3. BAGIAN DAFTAR SCRIM DAN FILTER
                SliverToBoxAdapter(
                  child: Padding(
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            return Column(
                              children: filteredScrims.map((s) => GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                    color: _statusColor(s['status'] as String? ?? 'open').withValues(alpha: 0.4),
                                                  ),
                                                ),
                                                child: Text(
                                                  _statusLabel(s['status'] as String? ?? 'open'),
                                                  style: TextStyle(
                                                    fontSize: 9,
                                                    color: _statusColor(s['status'] as String? ?? 'open'),
                                                    fontWeight: FontWeight.w700,
                                                  ),
                                                ),
                                              ),

...
class _PlatformHomeScreenState extends State<PlatformHomeScreen> {
        ...
        : SafeArea(
            ...
            child: CustomScrollView(
              slivers: [
                ...
                // 💡 GANTI bagian dua alert card di dalam build menjadi seperti ini:
                SliverToBoxAdapter(
                  child: Padding(
  ...
  // 💡 GANTI fungsi _alertCard lama kamu dengan yang ini:
Widget _alertCard(IconData icon, String title, String description, Color color, VoidCallback onTap, {required String ctaLabel}) =>
    GestureDetector(
      onTap: onTap,
      child: Container(
        padding: const EdgeInsets.all(14),
        ...
        child: Row(children: [
          // 💡 Sekarang menggunakan Widget Icon bawaan Flutter dengan warna yang dinamis

...
class _PlatformProfileScreenState extends State<PlatformProfileScreen> {
  // 1. DAFTAR INDEKS IKON (Wajib sama urutannya dengan di halaman Edit Profil)
  ...
  Widget build(BuildContext context) {
    ...
    // Sinkronisasi data nama lokal fallback jika data DB belum selesai dimuat
          ...
          : RefreshIndicator(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(children: [
                  ...
                  // 2. HEADER PROFIL ATAS YANG BISA DIKETUK UNTUK EDIT PROFIL
                  InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, AppRoutes.editProfilPlat).then((_) {
                        // Refresh data dari database otomatis saat user kembali (Back)
                        _fetchProfileData(); 
                      });
                    },
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                            colors: [const Color(0xFF3A0000).withAlpha(204), BooyahTheme.bg],
                      ...
                      child: Column(children: [
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: BooyahTheme.maroonGlow,
                                border: Border.all(color: BooyahTheme.maroonGlow.withAlpha(153), width: 2.5),
                                boxShadow: [BoxShadow(color: BooyahTheme.maroonGlow.withAlpha(51), blurRadius: 16)],
                              ),
                              child: ClipRRect(
                                ...
                                child: avatarUrl != null
                                    ? Image.network(
                                        ...
                                        errorBuilder: (context, error, stackTrace) => Center(
                                          child: Icon(_avatarCollection[avatarIndex], size: 36, color: Colors.white),
                                        ),
                                      )
                                    : Center(
                                        child: avatarIndex == 0 && _userData?['avatar_url'] == null
                                            ? const Text('🏢', style: TextStyle(fontSize: 34)) // Emoji default gedung lamamu
                                            : Icon(_avatarCollection[avatarIndex], size: 36, color: Colors.white),
                                      ),
                              ),
                            ),
                            ...
                            Positioned(
                              ...
                              child: CircleAvatar(
                                radius: 12,
                                backgroundColor: BooyahTheme.card,
                                child: const Icon(Icons.camera_alt_rounded, size: 11, color: BooyahTheme.maroonGlow),
                              ),
                            ),
                          ],
                        ),
                        ...
                        Text(
                          displayName.isEmpty ? 'Super Owner Platform' : displayName, 
                          style: const TextStyle(fontFamily: 'Orbitron', fontSize: 16, fontWeight: FontWeight.w900, letterSpacing: 1)
                        ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: BooyahTheme.maroonGlow.withAlpha(102)),
                          ),
                  ...
                  Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      // 3. MENU GRUP SISTEM (Sudah dipasang interseptor .then untuk merefresh layar)
                      _menuGroup('SISTEM', [
                        (Icons.person_outline, 'Edit Profil Platform', AppRoutes.editProfilPlat),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: BooyahTheme.red.withAlpha(76)),
                ...
                onTap: m.$3 != null
                    ? () {
                        Navigator.pushNamed(context, m.$3!).then((_) {
                          // Jika user masuk via menu Edit Profil Platform bawaan bawah, data tetap terefresh otomatis saat di-back!

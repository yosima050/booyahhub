...
class _KelolaPremiumScreenState extends State<KelolaPremiumScreen> {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              '${req['admin_name']} berhasil di-upgrade ke Premium!',
            ),
                  ...
                  child: Column(
                    children: [
                      _featureRow(
                        ...
                        'Scrim ditampilkan di halaman utama (featured)',
                      ),
                      _featureRow(
                        Icons.bar_chart_rounded,
                        'Laporan analytics detail per scrim',
                      ),
                      _featureRow(
                        Icons.vpn_key_rounded,
                        'Distribusi Room ID otomatis tanpa batas',
                      ),
                      _featureRow(
                        Icons.campaign_rounded,
                        'Kirim pengumuman massal tanpa batas',
                      ),
                      _featureRow(
                        Icons.verified_rounded,
                        'Badge "Admin Terpercaya" di profil',
                      ),
                    ],
                  ),
                ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  req['admin_name'] as String? ?? 'Admin',
                          ...
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () => _reject(req),
                                child: _btn('Tolak', BooyahTheme.red),
                              ),
                            ],
                          ),
                        ],
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            label,
            style: const TextStyle(fontSize: 7, color: BooyahTheme.textMuted),
  ...
  Widget _featureRow(IconData ico, String text) => Padding(
    padding: const EdgeInsets.symmetric(vertical: 5),
    child: Row(
      children: [
        Icon(ico, size: 16, color: BooyahTheme.gold),
        const SizedBox(width: 10),
        Expanded(
          child: Text(
            text,
            style: const TextStyle(fontSize: 11, color: BooyahTheme.textSec),
          ),
        ),
      ],
    ),
